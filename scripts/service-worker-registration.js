...
PROJECTMAP.ServiceWorkerRegistration = (function () {
  'use strict';
    ...
    if (!isAlreadyRegistered) {
      ...
      if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register(URL, {
              ...
              switch (installingWorker.state) {
                case 'installed':
                  if (!navigator.serviceWorker.controller) {
                    PROJECTMAP.Elements.Template.$.toast.showMessage(
          ...
          PROJECTMAP.Analytics.trackError('navigator.serviceWorker.register() error', e);
  ...
  if (navigator.serviceWorker && navigator.serviceWorker.controller) {
    navigator.serviceWorker.controller.onstatechange = function (event) {
      if (event.target.state === 'redundant') {
        ...
        if (PROJECTMAP.Elements && PROJECTMAP.Elements.Template &&
          PROJECTMAP.Elements.Template.$.toast.showMessage) {
          PROJECTMAP.Elements.Template.$.toast.showMessage(
